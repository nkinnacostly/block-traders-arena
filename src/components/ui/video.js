    ...
    <div className="px-[2rem] lg:px-[4rem] mt-[4rem]">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between space-y-8 lg:space-x-5 lg:space-y-0">
        <div className="w-full lg:w-[453px] h-[450px]  bg-white rounded-3xl lg:rounded-bl-3xl lg:rounded-br-3xl relative">
          ...
          />
          <div>
            <p className=" text-center text-black text-2xl font-medium mt-[2rem]">
              Trading for Beginners: Entry Level
            </p>
            <p className=" text-center text-stone-900 text-base font-normal mt-[2rem]">
              Introduction to Trading Basics for Beginners: Exploring the World
              of Financial Markets
            </p>
          </div>
        </div>
        <div className="lg:w-[453px] h-[450px]  bg-white rounded-3xl lg:rounded-bl-3xl lg:rounded-br-3xl relative">
          <Image
            src={"/assets/img/png/chart.png"}
            alt=""
            className="w-full rounded-tr-3xl rounded-tl-3xl"
          ...
          <Image
            src={"/assets/img/svg/play.svg"}
            alt=""
            className="absolute right-4 lg:top-[11rem] cursor-pointer top-[11rem]"
            height={70}
            width={70}
          />
          <div>
